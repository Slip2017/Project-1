 ...
 */
public class ShipComputer4 implements Ship {
    ...
    public ShipComputer4() {
    }

    public ShipComputer4(int shipType, PlaySpace space) {
    ...
    public void compareXY() {
        ...
        while (!(((initXY[0] == endXY[0]) & (Math.abs(initXY[1] - endXY[1]) == shipType - 1)) | ((initXY[1] == endXY[1]) & (Math.abs(initXY[0] - endXY[0]) == shipType - 1)))) {
            initXY = findXY();
            endXY = findXY();
        }
...
/*class TestComputer4 {
    public static void main(String[] args) {
        ShipComputer4 ob = new ShipComputer4(4, new PlaySpace(10));
        ob.createShip();
        System.out.println("Y "+Arrays.toString(ob.coordY));
        System.out.println("X "+Arrays.toString(ob.coordX));
